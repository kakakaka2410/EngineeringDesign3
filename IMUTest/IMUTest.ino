...
int initialValue1 = 10;
int initialValue2 = 45;
...
void setup()
{
  ...
  ESC1.write(initialValue1);
  ESC2.write(initialValue2);
...
void loop()
{
  ...
  if (Total_angle[2] >= 0){
    Input = -Total_angle[2];
    myPID.Compute();
    ESC1.write(initialValue1 - Output);
    ESC2.write(initialValue2 + Output);
  }
  else{
    Input =   Total_angle[2];
    myPID.Compute();
